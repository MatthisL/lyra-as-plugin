...
USTRUCT()
struct LYRAGAME_API FGlobalAppliedAbilityList
{
	GENERATED_BODY()
...
USTRUCT()
struct LYRAGAME_API FGlobalAppliedEffectList
{
	GENERATED_BODY()
...
UCLASS()
class LYRAGAME_API ULyraGlobalAbilitySystem : public UWorldSubsystem
{
	GENERATED_BODY()
